...
Function oOperatingSystems
	If isempty(g_oOperatingSystems) then
	
		oLogging.CreateEntry "Begin InitializeOSList...", LogTypeVerbose

		set g_oOperatingSystems = new ConfigFile
		g_oOperatingSystems.sFileType = "OperatingSystems"
		g_oOperatingSystems.sSelectionProfile = oEnvironment.Item("WizardSelectionProfile")
		g_oOperatingSystems.sCustomSelectionProfile = oEnvironment.Item("CustomWizardSelectionProfile")
		g_oOperatingSystems.sHTMLPropertyHook = " onPropertyChange='OSItemChange'"
		
		oLogging.CreateEntry "Finished InitializeOSList...", LogTypeVerbose
		
	End if
	set oOperatingSystems = g_oOperatingSystems
